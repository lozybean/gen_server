"""
Django settings for gen_server project.
...
SECRET_KEY = '$!3(+b$0@oehr^p0@#nj7nx+j_4=#be-71lwcjc#=s7*ytmn6*'
...
WSGI_APPLICATION = 'gen_server.wsgi.application'
